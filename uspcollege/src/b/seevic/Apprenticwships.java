...
public class Apprenticwships {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.cssSelector("#EmailAddress")).sendKeys("ccol@gmail.com");
		driver.findElement(By.cssSelector("#Password")).sendKeys("lkjh1234");
...
//				driver.findElement(By.id("PostBackModel_FirstName")).sendKeys("sss");
//				driver.findElement(By.id("PostBackModel_MiddleName")).sendKeys("lokj");
//				driver.findElement(By.id("PostBackModel_LastName")).sendKeys("tun");
//				driver.findElement(By.id("PostBackModel_AnotherName")).sendKeys("ndkl");
//				driver.findElement(By.id("PostBackModel_DateOfBirth")).sendKeys("01/09/1998");
//				Thread.sleep(2000);
...
//				driver.findElement(By.id("PostBackModel_TownOrCity")).sendKeys("emouth");
...
//				driver.findElement(By.id("PostBackModel_HomeNumber")).sendKeys("28990sj");
		// driver.findElement(By.id("PostBackModel_EmailAddress")).sendKeys("ccol@gmail.com");
...
//		driver.findElement(By.id("PostBackModel_ParentOrCarerPhoneNumber")).sendKeys("02472 582");
		// driver.findElement(By.id("PostBackModel_ParentOrCarerEmailAddress")).sendKeys("lnkkx@gmail.com");
		js.executeScript("window.scrollBy(0,500)");
		Thread.sleep(3000);
		...
		// step 7
		driver.findElement(By.id("single-select")).sendKeys("Pharmacy");
		js.executeScript("window.scrollBy(0,500)");
		Thread.sleep(3000);
		driver.findElement(By.xpath("//*[@id=\"mainContent\"]/div/div/div/div[2]/form/input[2]")).click();
...
//		driver.findElement(By.id("PostBackModel_LastCollegeOrSchool")).sendKeys("dfddc");
//		driver.findElement(By.id("PostBackModel_Qualifications_0__Subject")).sendKeys("cial");
//		driver.findElement(By.id("PostBackModel_Qualifications_0__Type")).sendKeys("kijch");
//		driver.findElement(By.id("PostBackModel_Qualifications_0__GradeOrPredictedGrade")).sendKeys("o");
...
//		driver.findElement(By.id("single-select")).sendKeys("Arab");
//		driver.findElement(By.id("PostBackModel_Nationality")).sendKeys("klojhdc");
//		driver.findElement(By.id("PostBackModel_Religion")).sendKeys("lid");
//		driver.findElement(By.id("PostBackModel_FirstLanguage")).sendKeys("ponhsc");
//		Thread.sleep(3000);
//
...
//		driver.findElement(By.xpath("//*[@id=\"mainContent\"]/div/div/div/div[2]/form/div[34]/label")).click();// no
		...
		driver.findElement(By.id("single-select")).sendKeys("Twitter");
